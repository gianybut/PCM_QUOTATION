      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="bg-gray-100">
            <th className="border py-1 px-2 text-center">Quantity</th>
            <th className="border py-1 px-2 text-center">Units</th>
            <th className="border py-1 px-2 text-center">Description</th>
            <th className="border py-1 px-2 text-center">Price per Unit</th>
            <th className="border py-1 px-2 text-center">Total</th>
            <th className="border py-1 px-2 text-center non-printable">Actions</th>
          </tr>
        </thead>
        <tbody>
          {rows.map((currentRow) => (
